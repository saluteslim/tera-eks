...
resource "aws_internet_gateway" "tes-igw" {
  ...
  depends_on = [aws_vpc.tes-vpc]
}

# Route Table(s)
# Route the public subnet traffic through the IGW
resource "aws_route_table" "tes-rtw" {
  vpc_id = aws_vpc.tes-vpc.id
...
resource "aws_route_table_association" "internet_access" {
  ...
  route_table_id = aws_route_table.tes-rtw.id
}
...
resource "aws_route" "main" {
  route_table_id         = aws_vpc.tes-vpc.main_route_table_id
  nat_gateway_id         = aws_nat_gateway.tes-ngw.id
